...
\needspace{4\baselineskip} % keep X number of lines together
{\bf Computer science}\smallskip\\
\begin{tabular}{@{}li{\pcolwdth}} %@{  } says add 2 spaces before each entry
...
\needspace{3\baselineskip} % keep X number of lines together
